...
| `config.allowUntestedMssqlVersion` | The same ceiling for SQL Server: releases newer than the 2022 series this release was probed against are refused unless set. The 2016 floor is not overridable |
